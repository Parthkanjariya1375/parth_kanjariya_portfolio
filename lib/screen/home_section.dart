...
class _HomeSectionState extends State<HomeSection> with SingleTickerProviderStateMixin {
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    top: -100,
                    left: -80,
                    child: _circle(size: 300, color: Colors.blue.withOpacity(0.15)),
                  ),

                  Positioned(
                    bottom: -120,
                    right: -80,
                    child: _circle(size: 350, color: Colors.purple.withOpacity(0.15)),
                  ),

                  /// Main Content
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: mobile ? 24.w : 80.w, vertical: 40.h),
                    child: Column(
                      children: [
                        /// Navbar
                        _buildNavbar(mobile),
                        ...
                        mobile
                            ...
                            : Row(
                                ...
                                children: [
                                  Expanded(flex: 6, child: _buildLeftSection(mobile)),
                                  Expanded(flex: 5, child: _buildRightSection(mobile)),
                                ],
                              ),
                      ],
                    ),
  ...
  Widget _buildNavbar(bool mobile) {
    final List<String> navItems = ["Home", "About", "Projects", "Skills", "Contact"];
  ...
  Widget _navItem(String title, {required bool isActive, required VoidCallback onTap}) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isActive ? Colors.deepPurpleAccent.withOpacity(0.2) : Colors.transparent,
          borderRadius: BorderRadius.circular(14.r),
          border: Border.all(color: isActive ? Colors.deepPurpleAccent : Colors.transparent),
        ),
        child: Text(
          title,
          style: TextStyle(
      ...
      children: [
        Container(
          ...
          child: Text(
            ...
            style: TextStyle(color: Colors.white70, fontSize: mobile ? 13.sp : 14.sp),
          ),
        ...
        ShaderMask(
          shaderCallback: (bounds) {
            return const LinearGradient(colors: [Color(0xff60a5fa), Color(0xffa78bfa)]).createShader(bounds);
          },
          child: Text(
            "Parth Kanjariya",
            textAlign: mobile ? TextAlign.center : TextAlign.left,
          ...
          child: DefaultTextStyle(
            ...
            child: AnimatedTextKit(
              ...
              animatedTexts: titles
                  .map((e) => TypewriterAnimatedText(e, speed: const Duration(milliseconds: 90)))
                  .toList(),
            ),
          ),
        ...
        SizedBox(
          ...
          child: Text(
            ...
            textAlign: mobile ? TextAlign.center : TextAlign.left,
            style: TextStyle(color: Colors.white60, fontSize: mobile ? 15.sp : 17.sp, height: 1.8),
          ),
        ...
        Wrap(
          ...
          spacing: 20.w,
          runSpacing: 20.h,
          children: [_primaryButton(), _secondaryButton()],
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: Colors.white.withOpacity(0.08)),
              boxShadow: [BoxShadow(color: Colors.blue.withOpacity(0.18), blurRadius: 60, spreadRadius: 10)],
            ),
            child: ClipOval(
              child: Image.network(
          ...
          ).animate().fade().scale(duration: 1000.ms, curve: Curves.easeOutBack),
        ],
      ),
    );
  }
  ...
  Widget _primaryButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Colors.blue.withOpacity(0.3), blurRadius: 25, offset: const Offset(0, 10)),
        ],
      ),
      child: Text(
        "Hire Me",
